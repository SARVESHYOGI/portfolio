    ...
    <div className="sticky">
      <div className="flex flex-col content-center justify-center items-center">
        <div className="flex m-4">
          <div className="fadde boxmanual bg-black  text-gray-100 mx-20 bg-cover border border-4 rounded-xl border-white">
        ...
        <div className="flex m-4">
          <div className="faddee boxmanual bg-black text-gray-100 mx-20 bg-cover border border-4 rounded-xl border-white">
